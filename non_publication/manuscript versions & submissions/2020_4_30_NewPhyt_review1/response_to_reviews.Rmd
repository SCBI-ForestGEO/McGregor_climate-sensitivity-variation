...
**We note that the intent was never to test for a decline in growth, but to examine how it varied across trees; hence, we do not see it as circular. However, we have dropped the criteria of decline in growth as part of how we defined drought. This does not change the drought years that qualify for inclusion.**
