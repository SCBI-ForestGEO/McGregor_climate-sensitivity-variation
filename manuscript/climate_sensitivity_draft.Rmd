...
Summary|  	## (limit 200) | 	No. of Tables | 	5  (**check if there's a figures/tables limit for regular research papers**- I don't see one)
...
Although the physiological mechanisms discussed above lead to generally consistent directions of growth responses to tree height and hydaulic traits across droughts, indicating the universality of the underlying mechanisms, the relative importantance of the drivers varied widely across droughts, indicating an interaction with drought characteristics (Tables 4-5). [**DISCUSS DIFFERENCES ACROSS DROUGHTS-- e.g., 1966 was preceded by two dry years, and height mattered most in this drought. ...**] Further research will be required to understand how drought characteristics interact with driver variables to shape tree growth responses.

As climate change drives increasing drought in many of the world's forests (*REFS*), the fate of forests and their climate feedbacks will be shaped by the biophysical and physiological drivers observed here. Tall trees with exposed crowns are suffering disroportionately, 
