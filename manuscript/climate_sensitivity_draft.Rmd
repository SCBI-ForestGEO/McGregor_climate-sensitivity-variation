...
Species traits (wood density, $LMA$, $PLA_{dry}$, and $\pi_{tlp}$) varied significantly among species (all p<0.05 in ANOVA; Table 2, Fig. **S4**).
Drought resistance also varied across species and by drought (Fig. **3**). 
