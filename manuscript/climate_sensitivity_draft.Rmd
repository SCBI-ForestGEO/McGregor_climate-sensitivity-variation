...
To do so, we compared models with all possible combinations of candidate variables and identified the full set of models within $\Delta$AICc=2 of the best model (that with lowest AICc). 
