...
While tree size can correlate with the depth of water extraction [@brum_2018_hydrological], the linkage is not consistent. Shorter trees can vary broadly in the depth of water uptake [@stahl_2013_depth], and larger trees may allocate more to abundant shallow roots that are beneficial for taking up water from rainstorms [@meinzer_partitioning_1999].
