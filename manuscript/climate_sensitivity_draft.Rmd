...
Wood density, $LMA$, and xylem porosity were all poor predictors of $Rt$ (Tables 1,4,5). 
Wood density and $LMA$ were never significantly associated with $Rt$ in the single-variable tests (Table 4) and were therefore excluded from the full models. 
Xylem porosity was also excluded from the full models, as it had no significant influence for all droughts combined and had contrasting effects in the individual droughts: whereas ring-porous species had higher $Rt$ than diffuse- and semi-ring- porous species in the 1966 and 1999 droughts, they had lower $Rt$ in 1977 (Table **4**). 
It is noteworthy that the two diffuse-porous species in our study, *Liriodendron tulipifera* and *Fagus grandifolia*, were at opposite ends of the $Rt$ spectrum (Fig. **2**), further refuting the idea that xylem porosity is a useful predictor of $Rt$. 

In contrast, $PLA_{dry}$, and $\pi_{tlp}$ were linked to drought responses (Tables 1,4,5). 
Both had consistent signs across all droughts and explained modest amounts of variation ($\Delta$AICc > 1.0) during at least one of the three droughts (Table 4), qualifying them as candidate variables for the full model. 
$PLA_{dry}$ was consistently included, with negative coefficient, in full models for the three droughts combined and for the 1966 and 1977 droughts individually (Table 5). 
$\pi_{tlp}$ was included in the top full model for all droughts combined and for the 1977 and 1999 droughts individually (Table 5).
...
Figure S3: Height (from reconstructed DBH) by canopy position across the three focal droughts and in the year of
measurement (2018)
