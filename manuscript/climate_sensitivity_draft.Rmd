...
1.2. (Beyond the effects of height,) canopy trees have lower drought resistance because they are exposed to higher solar radiation, greater wind speeds, and lower humidity. Alternatively, the generally supressed status of subcanopy trees may be insufficient to override the benefits of their buffered environment during drought. 

    (add predictions for model without height- ([issue #44](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/44)))
    * P1.2- After accounting for height, trees currently in a dominant canopy position have lowest resistance. (partially supported)
    * P1.2alt- After accounting for height, subcanopy trees have lowest resistance. (partially supported)
