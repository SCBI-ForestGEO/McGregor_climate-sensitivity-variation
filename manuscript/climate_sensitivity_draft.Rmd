...
We test a series of hypotheses and associated specific predictions (Table 1) based on the combination of tree-ring records from three droughts (1966, 1977, 1999), species trait measurements, and census and microenvironmental data from a large forest dynamics plot in Virginia, USA. 
...
$Rt$ had a significantly negative response to $ln[TWI]$ across all drought years combined and in 1977 and 1999 individually (Figs. **4, S6**, Table S6-S7). 
