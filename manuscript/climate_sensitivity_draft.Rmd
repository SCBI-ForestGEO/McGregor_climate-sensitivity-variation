...
trying to test how the negative effect of height is caused by the traits, 

(no) means there's a trend in the expected direction but not consistently significant

H2.3
if the effect is negative and is in every top model (<dAIC2), that would be "yes."
if the effect is negative mostly
