...
Based on this, we identified the three strongest droughts during the study period (Figs. **1, S1**; Table S3).

The droughts differed in intensity and antecedent moisture conditions (Fig. **S1**, Table S3). 
...
Species-specific height allometries were developed (Table S2) using log-log regression ($ln[H] \sim ln[DBH]$). 
