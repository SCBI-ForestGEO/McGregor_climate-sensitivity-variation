...
- next paragraph saying that our study advances understanding of droughts, e.g. bennett et al 2015 doesn't go into mechanisms but we do
  ...
  - we see no indication that rooting volume gives a relative advantage to large trees. Root systems are important, but [Bretfeld et al](https://nph-onlinelibrary-wiley-com.smithsonian.idm.oclc.org/doi/full/10.1111/nph.15071) show that "the limiting physiological processes for transpiration shifted from operating at the plant–soil interface to the plant–atmosphere interface with progressing forest succession.""
