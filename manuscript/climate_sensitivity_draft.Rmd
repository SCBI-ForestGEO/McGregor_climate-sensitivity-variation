...
In the context of the multivariate model, $Rt$ did not vary across drougth years. That is, drought year did not appear in any of the top models -- *i.e.*, models that were statistically indistinguishable ($\Delta$AICc<2) from the best model -- and therefore was excluded from the final model.  (**IAN, CONFIRM THIS**))
