...
**RESUME HERE**
$Rt$ had a significantly negative response to $ln[TWI]$ across all drought years combined (Fig. **4**, Table S8-S9). 
The effect was also significant for 1977 and 1999 individually (Fig. **4**, Table S8).
When $Rt_{ARIMA}$ was used as the response variable, the effect was significant in 1977, and included in some of the top models in 1966 and 1999 (Table S9).
...
This hypothesis was rejected, as the $ln[H] *ln[TWI]$ interaction was never significant, and had a positive sign in any top models in which it appeared (Tables 1, S8-S9).
This term did appear with a positive coefficient in the best $Rt_{ARIMA}$ model for all years combined (Table S9), indicating that the negative effect of height on  $Rt$ was significantly stronger in wetter microhabitats.
