...
kable(hypothesis_table, booktabs = TRUE, caption = "**Table 5. Multivariate models**", format = 'latex', escape = TRUE) %>%
  kable_styling(latex_options = c("scale_down", "hold_position"), font_size = 12, protect_latex = TRUE) %>%
...
Our results reveal how tree size, microhabitat, and hydraulic traits shape tree growth responses across three droughts in a temperate deciduous forest. The tendencey for larger trees to suffer more, which has been observed in forests around the world (**REFS**), was driven primarily by their height, with a marginal effect of crown exposure. We find on evidence that root water access increased drougth resistance; in contrast, trees in wetter topographic positions suffered more, and larger rooting volume provided no advange in the drier microenvironments. Together, these findings demonstrate that the height is the primary mechanism through which tree size mediates drought response. 
