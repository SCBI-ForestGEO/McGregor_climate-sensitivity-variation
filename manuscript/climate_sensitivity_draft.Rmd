...
They are exposed to higher wind speeds and lower humidity (Fig. **2a-b**), resulting in higher evaporative demand (**REFS**). 
Unlike other temperate forests where modestly cooler understory conditions have been documented (**REFS**), particularly under drier conditions (**REFS**), we observed no significant variation in air temperatures across the vertical profile (Fig. **2c**). 
...
*Saving this for references: Even under non-drought conditions, evaporative demand and maximum leaf temperatures increase with tree height [@smith_temperature_1977; @bretfeld_plant_2018; @kunert_revised_2017] .*
