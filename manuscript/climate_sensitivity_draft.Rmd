...
*Fourth, how significant is the effect of individual drought years?*
...
**3. Do species functional traits predict drought response?**
   ...
   * P3.1 - diffuse porous species are more sensitive than ring porous (previously observed in eastern dec forests- Elliot et al. 2015, Friedrichs et al. 2009)
    ...
    * P3.3 - higher leaf mass area correlates positively to drought resistance (more sclerophyllous vegetation [thick leaves] usually means more adaptation) [@abrams_adaptations_1990] [@guerfel_impacts_2009] <- *valid? it looks at olive trees*
