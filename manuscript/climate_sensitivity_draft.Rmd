...
In the multi-year model, we also included a fixed effect of drought year to represent the combined effects of differences in drought characteristics.
...
In contrast, $PLA_{dry}$, and $\pi_{tlp}$ were both negatively correlated to drought resistance (Fig. **4**; Tables 1,S4-S7). 
