...
In contrast, $PLA_{dry}$, and $\pi_{tlp}$ - the traits that qualified for inclusion in the full model (Table S4) - were both negatively correlated to drought resistance (Fig. **4**; Tables 1,S4-S5,S8-S9). 
