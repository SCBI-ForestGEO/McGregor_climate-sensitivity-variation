...
**2. Species functional traits predict drought response?**

   * P2.1 - diffuse porous species are more sensitive than ring porous (previously observed in eastern dec forests- Elliot et al. 2015, Friedrichs et al. 2009)
    * P2.2 - higher percent leaf area predicts higher drought stress
    * P2.3 - higher leaf mass area correlates positively to drought resistance (more sclerophyllous vegetation [thick leaves] usually means more adaptation) [@abrams_adaptations_1990] [@guerfel_impacts_2009] <- *valid? it looks at olive trees*
    * P2.4 - TLP correlates negatively with drought resistance (NEVER tested),
    * P2.5 - higher wood density means more drought resistant

**3. How are functional traits distributed across size classes, and how does this affect size-resistance relationship?**  ([issue #43](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/43))
...
**4. How do droughts vary in their effect on tree resistance? **
