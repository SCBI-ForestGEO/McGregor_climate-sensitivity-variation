...
kable(hypothesis_table, booktabs = TRUE, caption = "**Table 2. Summary of variables**", format = 'latex', escape = TRUE) %>%
  ...
  pack_rows("Independent variables", 2, 18, latex_gap_space = "1em", colnum = 1, hline_before = FALSE) %>%
