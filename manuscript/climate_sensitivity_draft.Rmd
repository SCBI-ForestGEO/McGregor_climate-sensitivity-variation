...
We further test predictions that species with low $PLA_{dry}$ have higher drought resistance, and that species whose leaves lose turgor lower water potentials (more negative $\pi_{tlp}$) have higher drought resistance. 
...
Air temperature did not vary across the vertical profile (Fig. **2c**).
...
There were significant differences in height across all crown position classes (Fig. **2d**).
