...
Because the resistance and resilience of growth to drought is linked to trees' probability of surviving drought (*[DeSoto et al. (2020)](https://www.nature.com/articles/s41467-020-14300-5)*; *Liu et al. 2019; DOI: 10.1038/s41558-019-0583-9*), understanding growth responses can also help elucidate which trees are most vulnerable to drought-induced mortality.
...
Greater stem capacitance (*i.e.*, water storage capacity) of larger trees may also confer resistance to transient droughts (*Phillips et al. 2003; DOI:10.1093/treephys/23.4.237; Scholz et al. 2011*).
...
These include leaf area shrinkage upon desiccation [$PLA_{dry}$; @scoffoni_leaf_2014] and the leaf water potential at turgor loss point ($\pi_{tlp}$), *i.e.,* the water potential at which leaf wilting occurs [@bartlett_correlations_2016; *Zhu et al. 2018*]. 
Both traits correlate with hydraulic vulnerability and drought tolerance as part of unified plant hydraulic systems [@scoffoni_leaf_2014; @bartlett_correlations_2016; *Zhu et al. 2018*; but see *Farrell et al. 2017*].
