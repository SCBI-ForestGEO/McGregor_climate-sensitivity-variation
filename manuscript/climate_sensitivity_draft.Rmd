...
Contrary to previous studies in temperate deciduous forests, we did not find an association between xylem porosity and drought resistance, as the two diffuse-porous species, *Liriodendron tulipifera* and *Fagus grandifolia*, were at opposite ends of the $Rt$ spectrum (Fig. **3**). 
...
Resilience and survival are both linked to resistance (**REFS**), implying that the same factors may influence these. 
...
Ultimately, distributions of tree heights and drought tolerance traits across broad moisture gradients suggest that forests exposed to more drought will ultimately shift towards shorter stature (**REFS**) and be dominated by species with more drought-tolerant traits (**REFS**).
