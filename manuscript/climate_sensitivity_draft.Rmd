...
Because the resistance and resilience of growth to drought is linked to trees' probability of surviving drought [@desoto_low_2020; @liu_hydraulic_2019], understanding growth responses can also help elucidate which trees are most vulnerable to drought-induced mortality.
...
The earlier-successional species at our site (*Liriodendron tulipifera*, *Quercus spp.*, *Fraxinus americana*) display a mix of traits conferring drought resistance (Table 2), while the late-successional *Fagus grandifolia* displayed high drought resistance, in part because it exists primarily within a buffered microenvironment. 
**This has potentially far-reaching implications for future forests. If we accept that climate change will cause more intense droughts, it is possible we will see a shift from mature forests with buffering, tall trees to forests with a shorter overall height (e.g.** see @mcdowell_pervasive_2020). **At this point, species that had high resistance due to buffering (such as F. grandifolia) may in turn become more susceptible. This shift, in addition to the susceptiblity of large trees to fire and pests/pathogens, could be highly detrimental to temperate forests. That being said,**
Further research on how leaf drought tolerance traits and drought vulnerability change over the course of succession would be valuable for addressing how drought resistance changes as forests age [e.g. @rodriguez-caton_long-term_2015]. 
