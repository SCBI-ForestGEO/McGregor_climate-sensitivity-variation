...
### droughts(?)
[description of the 3 droughts in terms of timing, duration, severity, proportion of trees showing pointer year..?. See [Slette et al. (2019)](https://onlinelibrary-wiley-com.smithsonian.idm.oclc.org/doi/abs/10.1111/gcb.14747)]
...
trees_all_bio$year <- as.character(trees_all_bio$year)
...
r <- rsquared(best)
r <- r[, c(1,6)]
r$Response <- as.character(r$Response)
r[1,1] <- "r^2"
setnames(r, old=c("Response", "Conditional"), new=c("coefficients", "value"))
cof_bio <- rbind(cof_bio, r)
```
...
trees_all_full$year <- as.character(trees_all_full$year)
