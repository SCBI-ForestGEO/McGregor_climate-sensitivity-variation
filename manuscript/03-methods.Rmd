...
$$
diamYEAR = dbh2008 - 2*(bark.depth2008) - 2*\Sigma(ring.width1999:ring.width2008) + 2*(bark.depth_YEAR)
$$
...
[**We should find a way to present this analysis in one paragraph (no tables!) of main body text. If you need to stick with species/crown position-level analysis, any tables and detailed description should go in SI**]
