...
```{r, individual_tested_traits, eval=TRUE, echo=FALSE, message=FALSE}
traits_test <- read.csv("tables_figures/tested_traits_all.csv")
kable(traits_test) %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE)
```

```{r, all_candidates, eval=TRUE, echo=FALSE, message=FALSE}
candidates <- read.csv("tables_figures/candidate_traits.csv")
kable(candidates) %>%
  kable_styling(bootstrap_options = "striped", full_width = FALSE)
```

```{r, tested_traits_best, eval=TRUE, echo=FALSE, message=FALSE}
