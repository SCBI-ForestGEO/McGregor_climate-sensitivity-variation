...
**A GLMM would only avoid transformation of the dependent variable (Rt), but that was (and is) not transformed. We tried the analysis with generalized linear mixed models, and confirmed that this gave very similar results, but are sticking with LMM because...**

[*issue #94*](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/94)
[*issue #107*](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/107)
...
**maybe include these in fig with $Rt$ across species? [*issue #100*](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/71)*
