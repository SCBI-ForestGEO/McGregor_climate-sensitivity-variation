...
*from Lawren: "Re the trait values, I believe we would see species differences, even with n=3, looking at the means and SD presented. Suggest to run an ANOVA on each trait (and/or a MANOVA on all traits) and put the significance values in a new row in Table 3.  (BTW also suggest limiting values in Table 3 to 3 sig figs, and presenting SE in that Table with the means rather than SD)."*
