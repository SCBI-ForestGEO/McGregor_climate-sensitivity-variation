...
**We switched to use of Generalized linear mixed models. This did not change the outcome of any analyses.**
...
*This is an interesting suggestion. Depending on where we end up going with some other issues, it may make sense to de-emphasize the individual models--perhaps move Table 5 to SI and replace with figure ([issue #71](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/71))? However, I think we could also just make an argument for leaving this as is.*

related to [*issue #71*](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/71)
...
[*issue #95*](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/95)
...
*Ugghh, this doesn't even change anything--we'd still be analyzing the same 3 droughts! The question is whether to remove the growth reduction criteria. I personally think that analyzing 2 criteria is a strength, as our goal was to identify droughts that were both climatologically and biologically signficant. In any case, this is just an issue of changing the wording.*

*IM - I've updated the language in the manuscript, I think it's better.*

Other minor comments:

- Line 113: correct ‘positively’. **done**

- Line 134: cambial growth also includes that of phloem; so better refer to ‘xylem growth’. **done**
...
should be rather straightforward and the authors would increase accuracy across species in height estimation.
  - *IM I'm confused about how to answer this. There's no direct response to the first question, as the measurements I got (along with Atticus and previous measurements) were all lumped into the pot to make the regression equations, which we explain. Otherwise, I did go out and confirm measurements. I guess my only response (and question to you @teixeirak) is it worth explaining how disparate our data was and that's why we have different methods? Along with me going and getting new ones?*

- Lines 166-167: please explain further the hypothesis and why. *IM this is now line 170. I'm a little confused myself.*

- Line 222: what about climate in years before 1991? *IM I don't get this. At the beginning of the paragraph we say we looked at droughts 1950-2009...*

- Line 231: define AICc. **This is done (with added reference)**

- *IM I'm a bit confused by the next three comments.*
...
**We have modified the text here to read:
"Candidate variables were selected, based on the single-variable tests, as those that had a consistent direction of response across all droughts and whose addition to a corresponding null model improved fit (at $\Delta$AICc $\ge$ 1.0) in at least one drought year (Table 4). We note that the $\Delta$AICc $\ge$ 1.0 criterion is not a test of signficance, but of whether the variable has enough influence to be considered as a *candidate* variable in full models."**
...
*this is true of crown position, not height*
- *IM how do we want to officially respond to this?*
...
**IM I have done this for Rt, see below. I notice we don't have negative at all, just above or below 0. I'm assuming this is what the reviewer is referring to? Assuming this should be SI plot? Please let me know if you think this figure should be altered at all. **
![Rt across species](tables_figures/rt_across_species.png)
...
- Line 331-333: not so sure about this. It can also mean that there is no causal relationship between Rt and covariates, mostly because radial growth Rt should not be used as an integral proxy of tree resistance to drought, such as it is often used now in the literature.
  - *IM Krista do you know more about this?*

- Line 334-339: indeed, assessment of these two variables is not conclusive, as suggested above (just data from 2018, from the past estimated and correlated). *IM does this need a response?*

- Line 348: non-drought. *IM do we have the original submitted draft? I'm not sure what this is referring to*
...
- Line 349: do authors really think that lower radial growth as from Rt on a specific year means that the tree is more vulnerable? I think this is over conclusive.
  - *IM well, in our original course of thinking about it as based on Lloret, yes, Rt is a measure of a tree's particular resistance, and it fluctuates from year to year. Maybe the reviewer would have preferred if we had said that lower radial growth shows the tree was more vulnerable *in that year*? And then we reiterate that the focal drought years all had low Rt?*
  - *That being said, we're now using arima ratio and all values of Rt are positive. Regardless, I don't see where we make the full claim the reviewer is referring to.*
...
- *IM Krista, isn't the number of cores synonymous for us with the sample size for each species?*

Table 3: the authors could show some test to see if the traits presented are different among species.
- *IM Krista, do you think this is necessary? This would require extra stats to say something like "x traits did not differ significantly across species." I'm not sure how that result would affect our conclusions/writing.*

Table S1 and S2: correct R2. *IM I added the correct Latex notation but it's not rendering it when I knit the file...*

Table S3: please, explain what ‘rank’ means. *IM Krista, do you remember? Is this from the pointer year exercise? Or was this ranking the months in the context of each year's PDSI?*
...
- *IM seems like this comment is meant for the paper than for Figure S3. What do you think?*
...
*What a nice review! We can easily add some language on the importance.*
...
*good point. hypothesis refers to temperate deciduous biome.*
