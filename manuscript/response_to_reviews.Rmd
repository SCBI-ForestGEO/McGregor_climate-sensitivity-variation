...
*(1) keep a version of table 5 in the main text, showing just the top model for Rt, and maybe also that of $Rt_{ARIMA}$.  *

*(2) put full versions of table 2 (for Rt and $Rt_{ARIMA}$), including all models within the top dAICc=2, in the appendix*


related to [*issue #71*](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/71)

related to [*issue #99*](https://github.com/SCBI-ForestGEO/McGregor_climate-sensitivity-variation/issues/99)
...
*This table is definitely not just exploratory, and is the source for supporting/ rejecting predictions in Table 1. Thus, keeping it in the main text could be justified. That said, it presents mainly negative results, and I'd like to reduce the number of tables, so moving it to the appedix would be fine.*
...
*Regarding Fig. 2, my current inclination is to keep it While I think its true that such profiles are common, I'm not currently aware of a lot of studies showing such profiles. I just prepared a grant proposal related to this, and current intern Nidhi Vinod is working on a review on vertical profiles in temperature, so I'd hope I'd be relatively up to speed... I'll check into this more and come back to it.*
...
*good point. hypothesis refers to temperate deciduous biome, and turns out to be wrong.*
