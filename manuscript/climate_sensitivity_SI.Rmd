...
```
We used linear regression on log-transformed data to relate $r_{bark}$ to the diameter inside bark from 2008 data. These were then used to determine $r_{bark}$ in the $DBH$ reconstruction. No bark correction was applied for *Fagus grandifolia*, which has thin bark. 
