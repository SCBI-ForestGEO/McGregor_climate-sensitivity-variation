...
![**Figure S6. Visualization of the best model ($\Delta$AICc=0) with data for all droughts combined.** Model coefficients are given in Table S6.](tables_figures/publication/FigureS6_best_model_with_data.png)
