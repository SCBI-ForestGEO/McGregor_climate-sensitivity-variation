...
![**Figure S7. Drought recovery ($Rc$) across species for the three focal droughts. Species that are assigned the same letter are not significantly different from each other with regard to the tested variable. Letter groupings do not transfer between variables.**](tables_figures/publication/FigureS7_Rc_across_sp.png)
