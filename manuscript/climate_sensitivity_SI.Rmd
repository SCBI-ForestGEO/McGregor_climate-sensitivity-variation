...
library(knitr)
library(kableExtra)
multivar_table <- read.csv("tables_figures/publication/table5_multivariable_models_lmer.csv", stringsAsFactors = FALSE, check.names = FALSE) 
...
library(knitr)
library(kableExtra)
multivar_table <- read.csv("tables_figures/publication/tableS6_multivariable_models_lmer_arimaratio.csv", stringsAsFactors = FALSE, check.names = FALSE) 
