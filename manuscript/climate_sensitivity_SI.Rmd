...
![**Figure S4. Distribution of independent variables by species.** Species that are assigned the same letter are not significantly different from each other with regard to the tested variable. Letter groupings do not transfer between variables.](tables_figures/publication/FigureS4_traits_signif.png)
