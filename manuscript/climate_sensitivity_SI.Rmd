...
\newpage
![Figure S3: **Distribution of independent variables by species.** Species that are assigned the same letter are not significantly different from each other with regard to the tested variable. ](tables_figures/publication/independent_variables_by_species.png)
