...
kable(singlevar_table, booktabs = TRUE, caption = "Table S4. Individual tests of species traits as drivers of drought resistance, where $Rt_{ARIMA}$ is used as the response variable. Delta AICc is the AICc of a model excluding the trait minus that of the model including it. Variable abbreviations are as in Table 2.", format = 'latex', escape = FALSE) %>%
