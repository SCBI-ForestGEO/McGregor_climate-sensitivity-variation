...
kable(singlevar_table, booktabs = TRUE, caption = "Table S4. Individual tests of species traits as drivers of drought resistance ($Rt$).", format = 'latex', escape = FALSE) %>%
...
library(knitr)
library(kableExtra)
multivar_table <- read.csv("tables_figures/publication/table5_multivariable_models_reform.csv", stringsAsFactors = FALSE, check.names = FALSE) 
