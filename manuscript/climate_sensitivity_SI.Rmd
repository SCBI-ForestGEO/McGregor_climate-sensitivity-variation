...
library(knitr)
library(kableExtra)
multivar_table <- read.csv("tables_figures/publication/tableS6_RRt_multivariable_models_CPout.csv", stringsAsFactors = FALSE, check.names = FALSE) 
...
library(knitr)
library(kableExtra)
multivar_table <- read.csv("tables_figures/publication/tableS7_Rt_multivariable_models_arimaratio_CPout.csv", stringsAsFactors = FALSE, check.names = FALSE) 
colnames(multivar_table)[1] <- "drought"
