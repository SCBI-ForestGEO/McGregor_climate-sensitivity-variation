...
Parentheses indicate that the prediction was supported by at least one but not all of the top  models (Table S6). Dash symbols indicate that the response was not significant (Table S4), or not represented in any of the top models (Table S6).
...
![3b](tables_figures/publication/Figure3_resilience_across_sp.png)
