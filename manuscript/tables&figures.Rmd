...
Parentheses indicate that the prediction was supported by one but not all of the top full models (Table **5**). Dash symbols indicate that the response was not significant/ not represented in any of the top full models.
