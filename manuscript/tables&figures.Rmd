...
kable(hypothesis_table, booktabs = TRUE, caption = "**Table 1. Summary of hypotheses, corresponding specific predictions, and results.** We count predictions as fully supported / rejected when the response matches/contradicts the prediction in both univariate and all top multivariate models (when applicable). Parentheses indicate that predictions were partially supported/ rejected--i.e., that the direction of response matched/contradicted the prediction but that the effect was not significant in all models.") %>%
  ...
  pack_rows("H1a. Larger, taller trees have lower drought resistance (Rt).", 1, 2, latex_gap_space = "1em", colnum = 1, hline_before = FALSE) %>%
  pack_rows("H1b. Trees with more exposed crowns have lower drought resistance.", 3, 4, latex_gap_space = "1em", colnum = 1, hline_before = FALSE) %>%
  pack_rows("H1c. Small trees (lower root volume) suffer more in drier microhabitats.", 5, 5, latex_gap_space = "1em", colnum = 1, hline_before = FALSE) %>%
  pack_rows("Species traits", 6, 10, latex_gap_space = "1em", colnum = 1, hline_before = TRUE) %>%
  pack_rows("H2a. conventional traits....", 6, 7, latex_gap_space = "1em", colnum = 1, hline_before = FALSE) %>%
  pack_rows("H2b. leaf hydraulic traits....", 9, 10, latex_gap_space = "1em", colnum = 1, hline_before = FALSE) %>%
