...
Parentheses indicate that the prediction was supported by one but not all of the top  models (Table S6). Dash symbols indicate that the response was not significant (Table S4)/ not represented in any of the top models (Table S6).
Asterisks indicate that the $Rt_{ARIMA}$ models (Table S5, S7) yielded a different result: 
*$Rt_{ARIMA}$ had a difference in significance/ inclusion in top  models.
