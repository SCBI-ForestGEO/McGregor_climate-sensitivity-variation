...
Sample sizes are after removal of outliers. Dashes under **Independent variables** indicate that the variable was available for all records. Xylem porosity sample sizes by vessel arrangement are for all drought scenarios combined.
