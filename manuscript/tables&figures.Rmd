...
kable(singlevar_table, booktabs = TRUE, caption = "Table 4. Individual tests of species traits as drivers of drought resistance ($Rt$ metric).", format = 'latex', escape = FALSE) %>%
