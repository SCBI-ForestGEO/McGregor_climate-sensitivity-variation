...
Sample sizes are after removal of outliers. Dashes indicate that the variable was available for all records. 
...
**Figure 3. Figure 3. Drought resistance, $Rt$ (a), and resilience, $Rs$ (b), across species for the three focal droughts.** Species codes are given in Table 2.
