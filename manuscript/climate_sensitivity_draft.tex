...
\caption{\label{tab:unnamed-chunk-4}**Table 2. Summary of variables**}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:unnamed-chunk-5}**Table 4. Univariate models**}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
...
ï»¿variable & category & null variables & dAICc & coefficients & dAICc & coefficients & dAICc & coefficients & dAICc & coefficients\\
\midrule
...
\caption{\label{tab:unnamed-chunk-6}**Table 5. Summary of R^2 and coefficients of the best multivariate models for each drought instance.** Models are ranked by AIC, and we show all models whose AIC value falls within 2.0 of the best model ($dAICc<2$).}
\centering
\resizebox{\linewidth}{!}{
\fontsize{12}{14}\selectfont
...
ï»¿drought & dAICc & R2 & Intercept & ln[H] & D & C & I & S & ln[TWI] & diffuse & semi-ring & ring & PLA & TLP\\
\midrule
\addlinespace[.4em]
